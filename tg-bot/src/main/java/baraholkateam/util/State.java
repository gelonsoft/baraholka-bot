...
public enum State {
    ...
    UserObyavleniyes("my_obyavleniyes", "Созданные пользователем актуальные объявления"),
    NewObyavleniye("new_obyavleniye", "Создание нового объявления"),
    DeleteObyavleniye("delete_obyavleniye", "Удаление созданного объявления"),
    ...
    NewObyavleniye_AddObyavleniyeTypes("add_obyavleniye_types", "Выбрать типы объявления"),
    ...
    SearchObyavleniyes("search_obyavleniye", "Поиск объявлений по хэштегам"),
    SearchObyavleniyes_AddObyavleniyeTypes("search_obyavleniye_types",
    ...
    SearchObyavleniyes_ShowFoundObyavleniyes("show_found_obyavleniyes",
